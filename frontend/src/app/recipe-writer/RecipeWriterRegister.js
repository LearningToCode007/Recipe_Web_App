    ...
    <Container>
      <Row className="justify-content-center" style={{ marginTop: 10 }}>
        ...
        <Col sm={6} md={4} style={{ marginLeft: 30 }}>
          <h2>Recipe Writer Registration</h2>
          <Form
            noValidate
            validated={validated}
...
export default RecipeWriterRegister;
